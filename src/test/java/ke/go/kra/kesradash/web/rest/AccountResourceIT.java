package ke.go.kra.kesradash.web.rest;

import static ke.go.kra.kesradash.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import ke.go.kra.kesradash.IntegrationTest;
import ke.go.kra.kesradash.config.Constants;
import ke.go.kra.kesradash.domain.User;
import ke.go.kra.kesradash.repository.AuthorityRepository;
import ke.go.kra.kesradash.repository.UserRepository;
import ke.go.kra.kesradash.security.AuthoritiesConstants;
import ke.go.kra.kesradash.service.UserService;
import ke.go.kra.kesradash.service.dto.AdminUserDTO;
import ke.go.kra.kesradash.service.dto.PasswordChangeDTO;
import ke.go.kra.kesradash.service.dto.UserDTO;
import ke.go.kra.kesradash.web.rest.vm.KeyAndPasswordVM;
import ke.go.kra.kesradash.web.rest.vm.ManagedUserVM;
